...
func (o *ImporterV1) Destroy() error {
	...
	if err := o.proxy.SendRequest(ImporterV1RequestDestroy, &ImporterV1DestroyRequest{}); err != nil {
		return err
	}
...
func (o *ImporterV1) Import(handle string) (*ImportedV1, error) {
	...
	if err := conn.SendRequest(o.proxy.ID(), ImporterV1RequestImport, &ImporterV1ImportRequest{
		ID:     wire.NewID(p.ID()),
		Handle: handle,
	}); err != nil {
...
func BindImporterV1(b wayland.Binder, name, version uint32) (*ImporterV1, error) {
